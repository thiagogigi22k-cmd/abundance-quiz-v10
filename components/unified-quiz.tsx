...
export default function UnifiedQuiz() {
  ...
  // Auto-scroll to second card ($17) when offer appears
  useEffect(() => {
          ...
          {showOffer && (
            <div ref={offerRef} className="w-full max-w-md mt-10 flex flex-col items-center animate-fade-in-offer">
              ...
              <div className="w-full flex flex-col gap-8">
                {[
                  { price: "$17", desc: "The life that begins to awaken.", image: "/images/seed-sprout.jpg", gold: true, link: "https://ageofabundance.mycartpanda.com/checkout/210183499:1" },
                  { price: "$27", desc: "The life of full abundance and manifestation.", image: "/images/seed-golden.jpg", gold: true, link: "https://ageofabundance.mycartpanda.com/checkout/210183496:1" },
                  { price: "$37", desc: "The life of divine overflow and miracles.", image: "/images/seed-divine.jpg", gold: true, link: "https://ageofabundance.mycartpanda.com/checkout" },
                ].map((seed, index) => (
